...
def test_output_verification_pass_case():
    ...
    result = runner._verify_output(
        "Successfully compiled competitive benchmark table with 10 companies.", "Compile table", "Table of competitors"
    )
...
def test_output_verification_fail_case():
    ...
    result = runner._verify_output(
        "Found 2 companies but didn't extract revenue.", "Compile revenue table", "Table with revenue"
    )
