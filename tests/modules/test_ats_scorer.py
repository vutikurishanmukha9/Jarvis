...
def test_ats_score_quick_scan_mode():
    ...
    res = scorer.calculate_ats_score(resume_text="Python Docker AWS FastAPI", jd_text="Python Docker Kubernetes AWS")
...
def test_ats_score_interpretation_badges():
    ...
    scorer = ATSScorer(mode="deep")
    res = scorer.calculate_ats_score(
        resume_text="Python developer with 3 years experience.", jd_text="Looking for a python engineer."
    )
