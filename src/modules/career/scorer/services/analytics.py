...
from src.modules.career.scorer.config import ANALYTICS_FILE
    ...
    try:
        with _analytics_lock:
            ...
            if os.path.exists(ANALYTICS_FILE):
                ...
                analytics = {
                    "analyses": [],
                    "summary": {"total_uploads": 0, "total_matches": 0, "avg_match_score": 0.0, "last_updated": None},
                }

            # Add new analysis
            analysis_entry = {"timestamp": datetime.now().isoformat(), "type": analysis_type, "data": data}
