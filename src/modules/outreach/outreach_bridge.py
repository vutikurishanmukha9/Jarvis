...
@tool
def preview_campaign_batch(subject_template: str, body_template: str, recipients_csv_text: str) -> str:
    """
...
@tool
def dispatch_email_campaign(subject_template: str, body_template: str, recipients_csv_text: str) -> str:
    """
    ...
    out = [
        ...
        "• Mode: Simulation (Agent-invoked dispatch is always simulated)",
...
def get_outreach_tools() -> List[BaseTool]:
    ...
    return [draft_personalized_outreach, generate_multi_stage_sequence, preview_campaign_batch, dispatch_email_campaign]
