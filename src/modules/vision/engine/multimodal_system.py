...
# Import Services
from .services import LlaVAService, LocalBlipService, LocalYoloService
...
class MultimodalAI:
    ...
    def process(
        self, image_path: str, question: str, analysis_config: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _get_default_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "object_detection": {"enabled": True, "confidence_threshold": 0.5, "iou_threshold": 0.45},
            "color_extraction": {"enabled": True, "num_colors": 5, "method": "kmeans"},
            "captioning": {
                "max_length": 50,
                "num_beams": 5,
                "temperature": 1.0,
    ...
    def process_batch(
        self, image_paths: List[str], questions: List[str], analysis_config: Optional[Dict[str, Any]] = None
    ) -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            for _image_index, detections, caption in zip(valid_indices, batch_detections, global_captions, strict=True):
